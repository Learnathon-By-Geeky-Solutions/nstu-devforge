                ...
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between">
                        <h4 class="my-2">Users List</h4>
                          @can('users.create')
                              <a href="{{ route('users.create') }}" class="btn btn-success btn-sm my-2"><i class="fa fa-plus"></i> Add New User</a>
                          @endcan
                    </div>
                            ...
                            <tbody>
                                @foreach ($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @can('users.show')
                                                <a href="{{ route('users.show', $item->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>
                                            @endcan
                                            @can('users.edit')
                                                <a href="{{ route('users.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
                                            @endcan
